...
printf("        |        12                                                               |       \n");
printf("        |                                                                       |       \n");
printf("        |__________________________________4_____________________________________|       \n");


    edge *link1=addEdge(topology,router0,router1,"eth0/1","eth1/1",1);
    edge *link2=addEdge(topology,router0,router2,"eth0/2","eth2/1",3);
    edge *link3=addEdge(topology,router0,router3,"eth0/8","eth8/1",15);
    edge *link4=addEdge(topology,router0,router4,"eth0/9","eth9/1",17);
    edge *link5=addEdge(topology,router0,router5,"eth1/2","eth2/2",19);
    
    edge *link6=addEdge(topology,router1,router2,"eth1/3","eth3/2",4);
    edge *link7=addEdge(topology,router1,router3,"eth1/9","eth9/2",15);
    edge *link8=addEdge(topology,router1,router4,"eth2/3","eth3/3",5);
    edge *link9=addEdge(topology,router1,router5,"eth2/4","eth4/3",10);
    
    edge *link10=addEdge(topology,router2,router3,"eth2/7","eth7/3",9);
    edge *link11=addEdge(topology,router2,router4,"eth2/8","eth8/3",30);
    edge *link12=addEdge(topology,router2,router5,"eth3/4","eth4/4",20);
    
    edge *link13=addEdge(topology,router3,router4,"eth3/5","eth5/4",4);
    edge *link14=addEdge(topology,router3,router5,"eth3/7","eth7/4",12);
    
    edge *link15=addEdge(topology,router4,router5,"eth3/8","eth8/4",16);
...
printf("	 3     l  	    |   R0      |                 / 			\n");
printf("	 	l 	    +           +	    	 /  4   			\n");
printf("	         l__________| 	        |_______________/  			\n"); 
printf("	        	    +-----+-----+  				          	\n");
printf("	                     /    |     l  				          	\n");
printf("	                    /     |      l      				   	\n");
printf("	                   /      |       l   				        	\n");
...
printf("	                    +------+----+ 					\n");
    ...
    edge *link1=addEdge(topology,router0,router1,"eth0/1","eth1/1",1);
    edge *link2=addEdge(topology,router0,router2,"eth0/2","eth2/1",3);
    edge *link3=addEdge(topology,router0,router3,"eth0/8","eth8/1",2);
    edge *link4=addEdge(topology,router0,router4,"eth0/9","eth9/1",5);
    edge *link5=addEdge(topology,router0,router5,"eth1/2","eth2/2",7);
    edge *link6=addEdge(topology,router0,router6,"eth1/3","eth3/2",4);
